...
do
cd rep_$i
Rscript /prj/furseal-genome/David/NES/SLiM/SLiM_3.7.1/WF/Parse_simulations_output_RAD_Boot.R $i
Rscript /prj/furseal-genome/David/NES/SLiM/SLiM_3.7.1/WF/Drift_Load_RAD_Boot.R $i
cd ../
done
...
# if (dim(files)[1]==25){
# 
# Nes<-read.table("/prj/furseal-genome/David/NES/SLiM/SLiM_3.7.1/WF/From_Boot/RAD_Boot_Ne.txt",h=F)
# GL<-c() # Genetic load
