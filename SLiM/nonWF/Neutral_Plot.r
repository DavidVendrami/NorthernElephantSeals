...
pdf("Supp_Neutral_P6.pdf",width=9.5, height=6.5)
par(mfrow=c(2,3))

# probs = c(1, 18/20, 3/20, 0, 0)
# barplot(probs, space = 1, yaxt='n',axes=F,ylab="",xaxt='n',xlab="",main="",col="white", border='white')
# 
# box(bty="l")
...
data<-read.table("Fin_Bt50_sizes.txt",h=F)
neut<-read.table("Pop_sizes_K50.txt",h=F)
...
for (i in 1:3){
par(new=T)
plot(neut[,i],type='l',ylim=c(0,350000),yaxt='n',axes=F,ylab="",xaxt='n',xlab="",main="",col=transp(n_col,tra), lwd=2)
}
put.fig.letter(label=expression(plain("b) Bottleneck ")~italic('K')~plain(" = 50")), location="topleft",cex=1.5)

##############

data<-read.table("Fin_Bt100_sizes.txt",h=F)
neut<-read.table("Pop_sizes_K100.txt",h=F)
ms<-apply(data,1,function(x) mean(x,na.rm=T))
plot((data$V1),type='l',ylim=c(0,350000),yaxt='n',axes=F,ylab="",xaxt='n',xlab="",main="",col=transp(sims,tra))
points(c(25-10.1,25-5.7,25-3.4,25-2.18,25-0),c(350,15000,120000,127000,225000),cex=2,pch=20,col=emp)
segments(c(25-10.1,25-5.7,25-3.4,25-2.18), c(350,15000,120000,127000), c(25-5.7,25-3.4,25-2.18,25-0), c(15000,120000,127000,225000), lwd=2, col=emp)
...
put.fig.letter(label=expression(plain("c) Bottleneck ")~italic('K')~plain(" = 100")), location="topleft",cex=1.5)

##############

data<-read.table("Fin_Bt250_sizes.txt",h=F)
neut<-read.table("Pop_sizes_K250.txt",h=F)
ms<-apply(data,1,function(x) mean(x,na.rm=T))
plot((data$V1),type='l',ylim=c(0,350000),yaxt='n',axes=F,ylab="",xaxt='n',xlab="",main="",col=transp(sims,tra))
points(c(25-10.1,25-5.7,25-3.4,25-2.18,25-0),c(350,15000,120000,127000,225000),cex=2,pch=20,col=emp)
segments(c(25-10.1,25-5.7,25-3.4,25-2.18), c(350,15000,120000,127000), c(25-5.7,25-3.4,25-2.18,25-0), c(15000,120000,127000,225000), lwd=2, col=emp)
...
put.fig.letter(label=expression(plain("d) Bottleneck ")~italic('K')~plain(" = 250")), location="topleft",cex=1.5)

##############

data<-read.table("Fin_Bt500_sizes.txt",h=F)
neut<-read.table("Pop_sizes_K500.txt",h=F)
ms<-apply(data,1,function(x) mean(x,na.rm=T))
plot((data$V1),type='l',ylim=c(0,350000),yaxt='n',axes=F,ylab="",xaxt='n',xlab="",main="",col=transp(sims,tra))
points(c(25-10.1,25-5.7,25-3.4,25-2.18,25-0),c(350,15000,120000,127000,225000),cex=2,pch=20,col=emp)
segments(c(25-10.1,25-5.7,25-3.4,25-2.18), c(350,15000,120000,127000), c(25-5.7,25-3.4,25-2.18,25-0), c(15000,120000,127000,225000), lwd=2, col=emp)
...
put.fig.letter(label=expression(plain("e) Bottleneck ")~italic('K')~plain(" = 500")), location="topleft",cex=1.5)

##############

data<-read.table("Fin_Bt1000_sizes.txt",h=F)
neut<-read.table("Pop_sizes_K1000.txt",h=F)
ms<-apply(data,1,function(x) mean(x,na.rm=T))
plot((data$V1),type='l',ylim=c(0,350000),yaxt='n',axes=F,ylab="",xaxt='n',xlab="",main="",col=transp(sims,tra))
points(c(25-10.1,25-5.7,25-3.4,25-2.18,25-0),c(350,15000,120000,127000,225000),cex=2,pch=20,col=emp)
segments(c(25-10.1,25-5.7,25-3.4,25-2.18), c(350,15000,120000,127000), c(25-5.7,25-3.4,25-2.18,25-0), c(15000,120000,127000,225000), lwd=2, col=emp)
...
put.fig.letter(label=expression(plain("f) Bottleneck ")~italic('K')~plain(" = 1000")), location="topleft",cex=1.5)
